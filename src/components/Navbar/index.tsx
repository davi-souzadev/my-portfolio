...
export function Navbar() {
  ...
  return (
    <nav className="bg-transparent ">
      <div className="max-w-6xl mx-auto px-4 border-b-[1px] border-gray-100 border-opacity-10 h-16">
        ...
        <div className="md:hidden w-full h-full flex justify-end items-center">
          <button
            className="border-[1px] p-1 rounded border-gray-100 border-opacity-20 mr-4"
      ...
      {isMenuOpen && (
        <div className="absolute flex items-end md:hidden bg-indigo-500 text-white flex-col w-full rounded-b">
          <a
            href="#"
